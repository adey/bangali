...
//log.debug "perf processChildSwitches: ${now() - nowTime} ms"
}
...
//log.debug "perf batteryCheck: ${now() - nowTime} ms"
}
...
//log.debug "perf checkDeviceHealth: ${now() - nowTime} ms"
}
